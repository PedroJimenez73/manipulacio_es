...
@Component({
  selector: 'app-diapo59',
  templateUrl: './diapo59.component.html',
  styleUrls: ['./diapo59.component.scss']
})
export class Diapo59Component implements OnInit {
    ...
    pregunta = {
        ...
        answers: [
            ...
            'Com que ha estat congelat ja s’han destruït els microorganismes.',
            'Totes son correctes.'
        ],
        corrects: ['a']
    }
