...
@Component({
  selector: 'app-diapo60',
  templateUrl: './diapo60.component.html',
  styleUrls: ['./diapo60.component.scss']
})
export class Diapo60Component implements OnInit {
    ...
    reset() {
        this.scormStoreService.resetUnit5();
    }
