...
@Component({
  selector: 'app-diapo-s8-p12',
  templateUrl: './diapo-s8-p12.component.html',
  styleUrls: ['./diapo-s8-p12.component.scss']
})
export class DiapoS8P12Component implements OnInit {
