...
export class Diapo17Component implements OnInit {
    ...
    pregunta = {
        id: '5',
        question: 'En quin moment es poden contaminar els aliments i patir una Toxi infecció alimentària:',
        answers: [
            'Ja venen contaminats d’orígen.',
            'En qualsevol nivell de la cadena alimentària.',
            'Quan els manipulem.'
        ],
        corrects: ['b']
    }
