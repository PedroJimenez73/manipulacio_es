...
@Component({
  selector: 'app-diapo-s8-p10',
  templateUrl: './diapo-s8-p10.component.html',
  styleUrls: ['./diapo-s8-p10.component.scss']
})
export class DiapoS8P10Component implements OnInit {
