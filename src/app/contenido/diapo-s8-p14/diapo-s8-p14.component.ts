...
@Component({
  selector: 'app-diapo-s8-p14',
  templateUrl: './diapo-s8-p14.component.html',
  styleUrls: ['./diapo-s8-p14.component.scss']
})
export class DiapoS8P14Component implements OnInit {
    ...
    reset() {
        this.scormStoreService.resetUnit8();
    }
