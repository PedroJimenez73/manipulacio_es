...
export class Diapo9Component implements OnInit {
    ...
    pregunta = {
        id: '3',
        question: 'Digues quina de les següents afirmacions és la correcta:',
        answers: [
            'Les empreses del sector alimentari tenen la responsabilitat d’oferir aliments saludables però també segurs.',
            'Tots els manipuladors d’aliments han de rebre una formació seguint la normativa vigent.',
