...
export class Diapo7Component implements OnInit {
    ...
    pregunta = {
        id: '1',
        question: 'Qui es considera manipulador d’aliments:',
        answers: [
            'Només les persones que cuinen i distribueixen els aliments.',
            'Les persones que tenen contacte directe amb els aliments durant tots el seus processos.',
            'Només qui té el carnet de manipulador d’aliments'
        ],
        corrects: ['b']
    }
